...
)->functools.partial(<function ft_hx at 0x7fbe113163e0>, 'div'): # Header cell element
...
def render_header_row(
    ...
    sort_url:str='', # Sort URL (empty = no click-to-sort)
)->functools.partial(<function ft_hx at 0x7fbe113163e0>, 'div'): # Header row element
...
)->functools.partial(<function ft_hx at 0x7fbe113163e0>, 'div'): # Cell element with stable ID
...
)->functools.partial(<function ft_hx at 0x7fbe113163e0>, 'div'): # Row element with stable ID
...
def render_slot(
    ...
    focus_url:str='', # URL for click-to-focus (empty = disabled)
)->functools.partial(<function ft_hx at 0x7fbe113163e0>, 'div'): # Slot wrapper (display:contents) containing the data row
...
def render_table_rows(
    ...
    render_cell:Callable, # Consumer cell render callback
    focus_url:str='', # URL for click-to-focus (empty = disabled)
)->functools.partial(<function ft_hx at 0x7fbe113163e0>, 'div'): # Table-row-group container with slot wrappers
...
def render_row_oob(
    ...
    ids:VirtualCollectionHtmlIds, # HTML IDs
    render_cell:Callable, # Consumer cell render callback
)->functools.partial(<function ft_hx at 0x7fbe113163e0>, 'div'): # Row element with hx-swap-oob
...
def render_cell_oob(
    ...
    render_cell:Callable, # Consumer cell render callback
    is_cursor:bool=False, # Whether row is keyboard cursor
)->functools.partial(<function ft_hx at 0x7fbe113163e0>, 'div'): # Cell element with hx-swap-oob
